     ...
     return (
       <div className='container'>
         <header>
             ...
             <div className="container-fluid">
               ...
               <div className="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                   ...
                   {userId && (
                     <li className="nav-item">
                       <Link className="nav-link text-warning-emphasis fs-8" to={`/orders/${userId}`}>Orders</Link>
                     </li>
                   )}
                   <li className="nav-item">
           ...
           <div className='icon'>
             <Link to="/showcart">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgba(116, 69, 32, 0.63)" className="bi bi-cart" viewBox="0 0 16 16">
